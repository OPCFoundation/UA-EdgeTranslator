...
> **Note**: OPC DA (OLE for Process Control Data Access) is a legacy protocol that relies on COM/DCOM and is limited to running only on Windows. When using UA Edge Translator natively on Windows.
