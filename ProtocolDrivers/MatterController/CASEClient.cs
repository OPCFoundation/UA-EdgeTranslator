namespace Matter.Core
{
    ...
    internal class CASEClient
    {
        ...
        internal ISession EstablishSession()
        {
            ...
            //            var caseSession = new SecureSession(_connection, BitConverter.ToUInt16(spake1SessionId), sigma2ResponderSessionId, encryptKey, decryptKey);
            var caseSession = new SecureSession(_connection, 0, 0, null, null);
