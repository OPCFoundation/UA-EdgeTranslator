...
namespace LoRaWan
{
    ...
    /// </summary>
    public readonly record struct MessageIntegrityCode
    {
...
#pragma warning restore IDE0032 // Use auto property
        ...
        public MessageIntegrityCode(int value) => this.value = value;
...
#pragma warning restore IDE0032 // Use auto property
        ...
        public static MessageIntegrityCode Read(ReadOnlySpan<byte> buffer) => new(BinaryPrimitives.ReadInt32LittleEndian(buffer));
        ...
        public static MessageIntegrityCode ComputeForJoinRequest(AppKey appKey, MacHeader mhdr, JoinEui joinEui, DevEui devEui, DevNonce devNonce)
        {
        ...
        public static MessageIntegrityCode ComputeForJoinRequest(NetworkSessionKey networkSessionKey, MacHeader mhdr, JoinEui joinEui, DevEui devEui, DevNonce devNonce)
        {
        ...
        private static MessageIntegrityCode ComputeForJoinRequest(byte[] keyBytes, MacHeader mhdr, JoinEui joinEui, DevEui devEui, DevNonce devNonce)
        {
            ...
            return new MessageIntegrityCode(BinaryPrimitives.ReadInt32LittleEndian(cmac));
        }

        public static MessageIntegrityCode ComputeForJoinAccept(AppKey appKey, MacHeader macHeader, AppNonce joinNonce, NetId netId, DevAddr devAddr, ReadOnlyMemory<byte> dlSettings, RxDelay rxDelay, ReadOnlyMemory<byte> cfList)
        {
        ...
        public static MessageIntegrityCode ComputeForData(NetworkSessionKey networkSessionKey, byte direction, DevAddr devAddr, uint fcnt, byte[] message)
        {
