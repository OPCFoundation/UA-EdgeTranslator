namespace Opc.Ua.Edge.Translator.ProtocolDrivers.MatterController
{
    using Matter.Core;
    ...
    {
        public static async Task<MessageExchange> SendCommand2(MatterAsset asset, Fabric fabric, ISession caseSession)
        {
        ...
        public static async Task<MessageExchange> SendCommand(MatterAsset asset, Fabric fabric, ISession caseSession)
        {
            var caseExchange = caseSession.CreateExchange();
        ...
        public static async Task<MessageExchange> SendCommand3(MatterAsset asset, Fabric fabric, ISession caseSession)
        { 
            var caseExchange = caseSession.CreateExchange();
